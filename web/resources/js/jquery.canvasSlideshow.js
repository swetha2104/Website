...
(function($) {
  ...
  $.fn.canvasSlideshow = function(options) {
    ...
    if (context.show_controls == true) {
      prev_img = new Image();
      prev_img.src = '../resources/images/images/prev.png';
      context.util_image[0] = prev_img;
      play_img = new Image();
      play_img.src = '../resources/images/images/play.png';
      context.util_image[1] = play_img;
      pause_img = new Image();
      pause_img.src = '../resources/images/images/pause.png';
      context.util_image[2] = pause_img;
      next_img = new Image();
      next_img.src = '../resources/images/images/next.png';
