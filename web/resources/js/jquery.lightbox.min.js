...
(function(b) {
    if (typeof window.console !== "object" || typeof window.console.emulated === "undefined") {
        if (typeof window.console !== "object" || !(typeof window.console.log === "function" || typeof window.console.log === "object")) {
            ...
            window.console.error = function() {
                for (var a = "An error has occured. More information will be available in the console log.", c = 0; c < arguments.length; ++c) {
            ...
            if (typeof window.console.debug === "undefined")
                window.console.debug = function() {
                    for (var a = ["console.debug:"], c = 0; c < arguments.length; c++)
                        a.push(arguments[c]);
                    window.console.log.apply(window.console, a)
                };
            if (typeof window.console.warn === "undefined")
                window.console.warn = function() {
                    for (var a = ["console.warn:"], c = 0; c < arguments.length; c++)
                        a.push(arguments[c]);
                    window.console.log.apply(window.console, a)
                };
            if (typeof window.console.error ===
                    "undefined")
                window.console.error = function() {
                    for (var a = ["console.error"], c = 0; c < arguments.length; c++)
                        a.push(arguments[c]);
                    window.console.log.apply(window.console, a)
                };
    ...
    String.prototype.queryStringToJSON = String.prototype.queryStringToJSON || function() {
        ...
        a = a.replace(/\+/g, "%20");
        if (a.substring(0, 1) === "{" && a.substring(a.length - 1) === "}")
            return eval(decodeURIComponent(a));
        a = a.split(/\&(amp\;)?/);
    ...
    Array.prototype.get = function(a, c) {
        if (a === "first")
            a = 0;
        else if (a === "last")
            a =
            ...
            a = this.index;
        c && this.setIndex(a);
        return this.exists(a) ? this[a] : undefined
    };
    Array.prototype.each = function(a) {
        for (var c = 0; c < this.length; ++c)
            if (a(c, this[c], this) === false)
                break;
        return this
    };
    Array.prototype.validIndex = function(a) {
        return a >= 0 && a < this.length
    };
    ...
    Array.prototype.set = function(a, c) {
        if (a < this.length && a >= 0)
            ...
            throw Error("Array.prototype.set: [index] above this.length");
        return this
    };
    ...
    Array.prototype.has = Array.prototype.has || function(a) {
        for (var c = false, d = 0, e = this.length; d < e; ++d)
            if (a == this[d]) {
                c = true;
                break
            }
    ...
    b.fn.binder = b.fn.binder || function(a, c, d) {
        var e = b(this);
        if (d)
            e.bind(a, c, d);
        else {
    ...
    b.event.special.lastclick = b.event.special.lastclick || {setup: function() {
            b(this).bind("click", b.event.special.lastclick.handler)
        }, teardown: function() {
            b(this).unbind("click", b.event.special.lastclick.handler)
        }, handler: function(a) {
            var c = function() {
                var d = b(this), e = d.data("lastclick-timeout") ||
                        false;
                e && clearTimeout(e);
                e = false;
                d.data("lastclick-timeout", e)
            };
            (function(d) {
                var e = this;
                c.call(e);
                ...
                var i = setTimeout(function() {
                    var g = f.data("lastclick-clicks");
                    c.apply(e, [d]);
                    f.data("lastclick-clicks", 0);
                    d.type = "lastclick";
                    b.event.handle.apply(e, [d, g])
                }, 300);
                f.data("lastclick-timeout", i)
            }).apply(this, [a])
        }};
    ...
    b.fn.lightbox = function(a) {
        ...
        if (b.Lightbox.ie6 && !b.Lightbox.ie6_support)
            return this;
        a = b.extend({start: false, events: true}, a);
        var c = b(this);
        if (a.events) {
            c.preventDefault().once("lastclick", function(d) {
                var e = b(this);
                e = c.index(e);
                if (!b.Lightbox.init(e, c))
                    return false;
                if (!b.Lightbox.start())
                    return false;
                d.preventDefault();
    ...
    b.extend(b.LightboxClass.prototype, {images: [], constructed: false, compressed: null, src: null, baseurl: null, files: {compressed: {scripts: {lightbox: "scripts/jquery.lightbox.min.js", colorBlend: "scripts/jquery.color.min.js"}, styles: {lightbox: "styles/jquery.lightbox.min.css"}}, uncompressed: {scripts: {lightbox: "scripts/jquery.lightbox.js", colorBlend: "scripts/jquery.color.js"}, styles: {lightbox: "styles/jquery.lightbox.css"}}, images: {prev: "images/prev.gif", next: "images/next.gif", blank: "images/blank.gif", loading: "images/loading.gif"}},
        ...
        auto_resize: true, ie6: null, ie6_support: true, colorBlend: null, download_link: true, show_helper_text: true, show_linkback: true, show_info: "auto", show_extended_info: "auto", options: ["show_helper_text", "auto_scroll", "auto_resize", "download_link", "show_info", "show_extended_info", "ie6_support", "colorBlend", "baseurl", "files", "text", "show_linkback", "keys", "opacity", "padding", "speed", "rel", "auto_relify"], construct: function(a) {
            ...
            if (c && typeof a.files === "undefined") {
                this.compressed = null;
                var f = b("script[src*=" + this.files.compressed.scripts.lightbox + "]:first");
                if (f.length !== 0) {
                    b.extend(true, this.files, this.files.compressed);
                    this.compressed = true
                } else {
                    f = b("script[src*=" + this.files.uncompressed.scripts.lightbox + "]:first");
                    if (f.length !== 0) {
                        b.extend(true,
                ...
                if (this.compressed === null) {
                    ...
                    this.files = e(this.files, this.baseurl);
                    a = b.extend(a, this.src.queryStringToJSON())
                }
                this.images.image = {src: "", title: "Untitled", description: "", name: "", color: null, width: null, height: null, id: null,
                    image: true};
                this.images.prepare = function(g) {
                    var h = b.extend({}, this.image);
                    if (g.tagName) {
                        g = b(g);
                        if (g.attr("src") || g.attr("href")) {
                            h.src = g.attr("src") || g.attr("href");
                            h.title = g.attr("title") || g.attr("alt") || h.title;
                            h.name = g.attr("name") || "";
                            h.color = g.css("backgroundColor");
                            g = h.title.indexOf(": ");
                            if (g > 0) {
                                h.description = h.title.substring(g + 2) || h.description;
                                h.title = h.title.substring(0, g) || h.title
                            }
                        } else
                            h = null
                    } else
                        h = g.src ? b.extend(this.image, g) : null;
                    if (h)
                        h.id = h.id || h.src + h.title + h.description;
                    return h
                };
                this.images.create = function(g) {
                    var h = this;
                    if (g.each)
                        g.each(function(k, l) {
                            h.create(l)
                        ...
                        var j = h.prepare(g);
                        j ? h.push(j) : window.console.error("We dont know what we have:", g, j);
                        return h
                    }
                }
            } else if (typeof a.files === "object")
                a.files = e(a.files, this.baseurl);
            else
                d = false;
            for (var i in this.options) {
                f = this.options[i];
                if (typeof a[f] === "object" && typeof this[f] === "object")
                    this[f] = b.extend(true, this[f], a[f]);
                else if (typeof a[f] !== "undefined")
                    this[f] = a[f]
            }
            delete i;
            this.ie6 = c && navigator.userAgent.indexOf("MSIE 6") >=
                    0 ? true : false;
            if (d || typeof a.download_link !== "undefined" || typeof a.colorBlend !== "undefined" || typeof a.files === "object" || typeof a.text === "object" || typeof a.show_linkback !== "undefined" || typeof a.scroll_with !== "undefined")
                b(function() {
                    b.Lightbox.domReady()
                });
            return true
        }, domReady: function() {
            var a = document.getElementsByTagName(b.browser.safari ? "head" : "body")[0], c = this.files.styles, d = this.files.scripts;
            if (this.colorBlend === true && typeof b.colorBlend === "undefined")
            ...
            for (script in d) {
                ...
                e.src = d[script];
                e.id = "lightbox-script-" + script.replace(/[^a-zA-Z0-9]/g, "");
                b("#" + e.id).remove();
                a.appendChild(e)
            }
            delete d;
            ...
            b("body").append('<div id="lightbox-overlay"><div id="lightbox-overlay-text">' + (this.show_linkback ? '<p><span id="lightbox-overlay-text-about"><a href="#" title="' + this.text.about.title + '">' + this.text.about.text + "</a></span></p><p>&nbsp;</p>" : "") + (this.show_helper_text ? '<p><span id="lightbox-overlay-text-close">' + this.text.help.close + '</span><br/>&nbsp;<span id="lightbox-overlay-text-interact">' + this.text.help.interact + "</span></p>" : "") + '</div></div><div id="lightbox"><div id="lightbox-imageBox"><div id="lightbox-imageContainer"><img id="lightbox-image" /><div id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"></a><a href="#" id="lightbox-nav-btnNext"></a></div><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="' +
            ...
            this.ie6 && this.ie6_support && b("#lightbox-overlay").css({position: "absolute", top: "0px", left: "0px"});
            ...
            this.scroll === "follow" && b(window).scroll(function() {
                b.Lightbox.repositionBoxes()
            });
            b("#lightbox-nav-btnPrev").unbind().preventDefault().hover(function() {
                b(this).css({background: "url(" + b.Lightbox.files.images.prev + ") left 45% no-repeat"})
            }, function() {
                b(this).css({background: "transparent url(" + b.Lightbox.files.images.blank + ") no-repeat"})
            }).lastclick(function() {
                b.Lightbox.showImage("prev");
                return false
            });
            b("#lightbox-nav-btnNext").unbind().preventDefault().hover(function() {
                b(this).css({background: "url(" +
            ...
            this.images.clear();
            this.images.create(c);
            if (this.images.isEmpty()) {
                window.console.warn("WARNING", "Lightbox started, but no images: ", a, c);
                return false
            }
            if (!this.images.current(a)) {
            ...
            this.visible = true;
            this.scroll === "disable" && b(document.body).css("overflow", "hidden");
            ...
            this.images.reset();
            this.scroll === "disable" && b(document.body).css("overflow", "visible");
            this.visible = false
        }, resizeBoxes: function(a) {
            if (a !== "transition") {
                var c = b(this.ie6 ? document.body : document);
                b("#lightbox-overlay").css({width: c.width(), height: c.height()});
                delete c
            }
            switch (a) {
                case "general":
                ...
                case "resized":
                    if (this.auto_resize === false) {
                        this.repositionBoxes({nHeight: g, speed: this.speed});
                        return true
                    }
                case "transition":
                default:
            ...
            var i = b("#lightbox-imageBox").width();
            f = b("#lightbox-imageBox").height();
            e = c + this.padding * 2;
            var g = d + this.padding * 2;
            i = i - e;
            f = f - g;
            b("#lightbox-nav-btnPrev,#lightbox-nav-btnNext").css("height", g);
            b("#lightbox-infoBox").css("width", e);
            if (a === "transition")
                if (i === 0 && f === 0) {
                    ...
                    b("#lightbox-imageBox").animate({width: e, height: g}, this.speed, function() {
                        b.Lightbox.showImage(null, 3)
                    })
                }
            else {
                b("#lightbox-image").animate({width: c, height: d}, this.speed);
                b("#lightbox-imageBox").animate({width: e, height: g}, this.speed)
            }
            this.repositionBoxes({nHeight: g, speed: this.speed});
            return true
            ...
            a.speed = a.speed || "slow";
            var c = this.getPageScroll(), d = a.nHeight || parseInt(b("#lightbox").height(), 10);
            d = c.yScroll + (b(window).height() - d) / 2.5;
            c = {left: c.xScroll, top: d};
            if (a.speed)
                b("#lightbox").animate(c, "slow", function() {
                    if (b.Lightbox.reposition_failsafe) {
                        b.Lightbox.repositioning = b.Lightbox.reposition_failsafe = false;
                        b.Lightbox.repositionBoxes(a)
                    } else {
                        b.Lightbox.repositioning = false;
                ...
                if (this.reposition_failsafe) {
                    this.repositioning =
                            this.reposition_failsafe = false;
                    this.repositionBoxes(a)
                } else
            ...
            c = c || 1;
            if (a = this.images.current(a) || this.images.get("first", true)) {
                switch (c) {
                    case 1:
                        ...
                        break;
                    case 2:
                        b("#lightbox-image").attr("src", a.src);
                        if (typeof this.padding === "undefined" || this.padding === null || isNaN(this.padding))
                            this.padding = parseInt(b("#lightbox-imageContainer").css("padding-left"), 10) || parseInt(b("#lightbox-imageContainer").css("padding"), 10) || 0;
                        if (this.colorBlend) {
                            b("#lightbox-overlay").animate({backgroundColor: a.color}, this.speed * 2);
                            b("#lightbox-imageBox").css("borderColor", a.color)
                        }
                        this.resizeBoxes("transition");
                        break;
                    case 3:
                        b("#lightbox-loading").hide();
                        b("#lightbox-image").fadeIn(this.speed * 1.5, function() {
                            b.Lightbox.showImage(null, 4)
                        });
                        this.preloadNeighbours();
                        this.handlers.show !== null && this.handlers.show(a);
                        break;
                    case 4:
                        var e = b("#lightbox-caption-title").html(a.title || "Untitled");
                        if (this.download_link)
                            e.attr("href", this.download_link ? a.src : "");
                        delete e;
                        b("#lightbox-caption-seperator").html(a.description ? ": " : "");
                        b("#lightbox-caption-description").html(a.description || "&nbsp;");
                        this.images.length > 1 ? b("#lightbox-currentNumber").html(this.text.image +
                                "&nbsp;" + (this.images.index + 1) + "&nbsp;" + this.text.of + "&nbsp;" + this.images.length) : b("#lightbox-currentNumber").html("&nbsp;");
                        ...
                        if (this.show_extended_info === true) {
                            ...
                            b("#lightbox-infoBox").trigger("mouseover")
                        } else
                            this.show_info ===
                                    true && b("#lightbox-imageBox").trigger("mouseover");
                        b("#lightbox-nav-btnPrev, #lightbox-nav-btnNext").css({background: "transparent url(" + this.files.images.blank + ") no-repeat"});
                        ...
                        break;
                    default:
                        window.console.error("Don't know what to do: ", a, c);
                        return this.showImage(a, 1)
                }
                return true
            }
        }, preloadNeighbours: function() {
            if (this.images.isSingle() ||
                    this.images.isEmpty())
                return true;
            var a = this.images.current(), c = this.images.index;
            if (!a)
                return a;
            ...
            this.images.setIndex(c);
            if (d = this.images.next()) {
                a = new Image;
                a.src = d.src
            }
            this.images.setIndex(c)
            ...
            if (d === this.keys.close || c === a)
                return b.Lightbox.finish();
            if (d === this.keys.prev || c === 37)
                return b.Lightbox.showImage("prev");
            if (d === this.keys.next || c === 39)
                return b.Lightbox.showImage("next");
            return true
            ...
            return{xScroll: a, yScroll: c}
        }, pause: function(a) {
            var c = new Date, d = null;
            do
                d = new Date;
            while (d - c < a)
        }});
    if (typeof b.Lightbox === "undefined")
        b.Lightbox = new b.LightboxClass
})(jQuery);
