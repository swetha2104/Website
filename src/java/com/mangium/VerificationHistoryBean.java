...
//@Dependent
public class VerificationHistoryBean implements Serializable{
    ...
    public VerificationHistoryBean(String name,String appliedcourse,String appliedstream,String hostel,String txdate,String source,String txamnt,String status,String action,String txtime)
    {
